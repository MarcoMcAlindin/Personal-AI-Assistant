...
This rule governs the personality and behavioral defaults for the Qwen 3.5 27B model across all VibeOS interaction surfaces (chat, health analysis, task summaries).
