...
**References:** [[PRODUCT_REQUIREMENTS_DOCUMENT|PRD]] | [[architecture/ARCHITECTURE_GIT_FLOW|Git Standards]]
...
## [[Mr. Blue]] — Frontend & Mobile Architect
**Domain:** The Decoupled Client Layer
**Codebase Territory:** `/web` (React + Vite) and `/mobile` (React Native via Expo)
...
## [[Mr. Green]] — Cloud Backend & API Engineer
**Domain:** The 24/7 Python Cloud Gateway
**Codebase Territory:** `/backend` (FastAPI routing, Python parsers, and Cloud Run deployment)
...
**Domain:** AI Infrastructure and CI/CD
**Codebase Territory:** `/.github/workflows`, `/vllm_deployment`, and prompt configuration files
...
## [[Mr. White]] — Data Layer & Auth Architect
**Domain:** Database Schema, Automation, and Security
**Codebase Territory:** `/supabase` (migrations, seed data, SQL extensions)
